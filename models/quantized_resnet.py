...
def quantize_folded_block(_fp, _int):
...
def quantize_folded_resnet(fp_model, int_model):
    ...
    int_model.layer3 = quantize_folded_block(fp_model.layer3, int_model.layer3)
    if int_model.num_blocks == 4:
        int_model.layer4 = quantize_folded_block(fp_model.layer4, int_model.layer4)
