...
__all__ = ["MobileNetV3", "mobilenet"]

model_urls = {
    "mobilenet": "https://download.pytorch.org/models/mobilenet_v3_small-047dcff4.pth",
}
...
class MobileNetV3(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            last_channel (int): The number of channels on the penultimate layer # 끝에서 두번째 layer
