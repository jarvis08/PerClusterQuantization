...
class Q_AlexNet(nn.Module):
    def __init__(self, model, model_dict=None, num_clusters=1):
        ...
        self.conv1.set_param(conv_block.conv, model_dict,
                             'features.stage1.unit1.conv')
        self.act1 = nn.ReLU()
        ...
        self.conv2.set_param(conv_block.conv, model_dict,
                             'features.stage2.unit1.conv')
        self.act2 = nn.ReLU()
        ...
        self.conv3.set_param(conv_block.conv, model_dict,
                             'features.stage3.unit1.conv')
        self.act3 = nn.ReLU()
        ...
        self.conv4.set_param(conv_block.conv, model_dict,
                             'features.stage3.unit2.conv')
        self.act4 = nn.ReLU()
        ...
        self.conv5.set_param(conv_block.conv, model_dict,
                             'features.stage3.unit3.conv')
        self.act5 = nn.ReLU()
        ...
        fc.in_features = 4096
        fc.out_features = model_dict['output.fc3.weight'].size(0)
