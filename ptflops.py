...
from models.layers.conv2d import QuantizedConv2d
from models.layers.linear import QuantizedLinear
from models.layers.norm import QuantizedBn2d
...
MODULES_MAPPING = {
    ...
    QuantizedConv2d : conv_flops_counter_hook,
    QuantizedBn2d : bn_flops_counter_hook,
    QuantizedLinear : linear_flops_counter_hook,
